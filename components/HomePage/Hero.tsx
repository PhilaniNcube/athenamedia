      ...
      <div className="max-w-7xl mx-auto px-4 bg-peach relative overflow-hidden py-10 md:rounded-3xl min-h-[70vh] max-h-[75vh] ">
        ...
        <div className="grid w-full h-full grid-cols-2">
          <div className="col-span-2 md:col-span-1 flex flex-col justify-center lg:h-[70vh] pl-3 ">
            ...
            <p className="pr-6 mt-4 mb-1 text-sm tracking-wide text-white md:mb-4 md:text-xl">
              We are dedicated tocrafting custom web solutions that deliver
              results for your business. We use the latest technology and best
              practices to create websites that are not only visually appealing,
              but also optimized for maximum performance.
            </p>
            <Link href="/contact">
